...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VANTAGE — Property Health Intelligence" },
      {
        name: "description",
        content:
          "VANTAGE turns community operations into a Living Score and investment intelligence for residential estates.",
      },
      { name: "author", content: "VANTAGE" },
      { property: "og:title", content: "VANTAGE — Property Health Intelligence" },
      {
        property: "og:description",
        content: "Know more than what a property costs. Know why it's worth it.",
      },
